...
namespace MotorCity.World
{
    public sealed class StreetSprintMarkerVisual : MonoBehaviour
    {
        ...
        public void Bind(StreetSprintActivity activity)
        {
            sprint = activity;
        ...
        private void Update()
        {
            ...
            if (markerRenderer != null)
            {
                ...
                markerRenderer.material.color = Color.Lerp(markerRenderer.material.color, target, Time.deltaTime * 7f);
            }
        }
        ...
        private void SnapToTarget()
        {
            ...
            transform.position = target + Vector3.up * (0.12f + Mathf.Sin(Time.time * 2.8f) * 0.04f);
        }
    }
}
