...
namespace MotorCity.World
{
    public sealed class DriftChallengeMarkerVisual : MonoBehaviour
    {
        ...
        public void Bind(DriftChallenge target)
        {
            challenge = target;
            if (challenge != null)
        ...
        private void Update()
        {
            ...
            transform.position = basePosition + Vector3.up * (Mathf.Sin(Time.time * 2.4f) * 0.035f);
            ...
            if (markerRenderer != null)
            {
                ...
                markerRenderer.material.color = Color.Lerp(markerRenderer.material.color, target, Time.deltaTime * 6f);
            }
        }
    }
}
