    ...
    public static class MotorCityLocalization
    {
        ...
        private static readonly Dictionary<string, LocalizedEntry> Entries =
            new()
            {
                ...
                { "vehicle.muscle.name", E("РЕЙНДЖЕР", "RANGER") },
                ...
                { "vehicle.muscle.desc", E("ПИКАП — высокий кузов, тяга и уверенность на дороге", "PICKUP — strong stance, torque and road presence") },
                ...
                { "vehicle.next_available", E("СЛЕДУЮЩАЯ: {0} • УЖЕ КУПЛЕНА", "NEXT: {0} • OWNED") },
                { "vehicle.next_buy", E("СЛЕДУЮЩАЯ: {0} • {1:N0} КР • B КУПИТЬ", "NEXT: {0} • {1:N0} CR • B BUY") },
                { "vehicle.next_rep", E("СЛЕДУЮЩАЯ: {0} • НУЖНО {1:N0} РЕП", "NEXT: {0} • NEED {1:N0} REP") },
                { "vehicle.not_owned", E("{0}: нажми B, чтобы купить за {1:N0} КР", "{0}: press B to buy for {1:N0} CR") },
                ...
                { "hud.garage_controls", E("1/2/3 УЛУЧШЕНИЯ • Z/X АВТО • B КУПИТЬ • V ЦВЕТ • E ЗАКРЫТЬ", "1/2/3 UPGRADES • Z/X CAR • B BUY • V COLOR • E CLOSE") },
                ...
                { "hud.character.story", E("ПУТЬ НОВИЧКА", "ROOKIE PATH") },
                { "hud.character.story_progress", E("ПУТЬ НОВИЧКА {0}/{1}", "ROOKIE PATH {0}/{1}") },
                ...
                { "garage.engine_desc", E("+{0} км/ч • +{1} разгон • +{2}% тяга", "+{0} km/h • +{1} accel • +{2}% power") },
                { "garage.grip_desc", E("+{0}% сцепление • меньше пробуксовки", "+{0}% grip • less wheelspin") },
                { "garage.stability_desc", E("-{0} мм центр массы • +{1}% стабильность", "-{0} mm center of mass • +{1}% stability") },
                ...
                { "turbo.title", E("БАЙТ", "BYTE") },
                { "turbo.hello", E("Байт: Привет! Я твой напарник. Поехали исследовать Motor City!", "Byte: Hi! I’m your co-pilot. Let’s explore Motor City!") },
                { "turbo.reunion", E("Байт: Я скучал! Ничего не потеряно — просто поехали кататься.", "Byte: I missed you! Nothing was lost — let’s go for a drive.") },
                { "turbo.mood_happy", E("РАДОСТНЫЙ", "HAPPY") },
                { "turbo.level_up", E("Байт получил уровень {0}! Новые способности становятся сильнее.", "Byte reached level {0}! His abilities are getting stronger.") },
                { "turbo.daily_any", E("БАЙТ • Выполни любые активности: {0}/{1}", "BYTE • Complete any activities: {0}/{1}") },
                { "turbo.daily_race", E("БАЙТ • Заверши гонку: {0}/{1}", "BYTE • Finish a race: {0}/{1}") },
                { "turbo.daily_drift", E("БАЙТ • Заверши дрифт-заезд: {0}/{1}", "BYTE • Finish a drift challenge: {0}/{1}") },
                { "turbo.daily_done", E("БАЙТ • Задание на сегодня выполнено", "BYTE • Today’s task is complete") },
                { "turbo.daily_progress", E("Байт: Отлично! Задание {0}/{1}.", "Byte: Nice! Task progress {0}/{1}.") },
                { "turbo.daily_reward", E("Байт: Задание готово! +{0:N0} КР и опыт Байт.", "Byte: Task complete! +{0:N0} CR and Byte XP.") },
                { "turbo.new_daily", E("Байт: Новое приключение на сегодня готово!", "Byte: Today’s new adventure is ready!") },
                { "turbo.hint", E("Байт: Не спеши — цель уже отмечена на миникарте.", "Byte: No rush — your target is already marked on the minimap.") },
                { "turbo.boost", E("Байт: Пуск! Короткий буст активирован.", "Byte: Go! Short boost activated.") },
                { "turbo.garage_skin", E("БАЙТ • СКИН: {0}", "BYTE • SKIN: {0}") },
                ...
                { "turbo.skin_cosmetic_pack", E("БАЙТ-ИСКРА", "BYTE SPARK") },
                { "turbo.skin_unlocked", E("Байт: открыт новый скин «{0}»!", "Byte: new skin “{0}” unlocked!") },
                { "turbo.skin_selected", E("Байт: выбран скин «{0}».", "Byte: “{0}” skin selected.") },
            ...
            { "touch.garage.next", E("СЛЕД. АВТО", "NEXT CAR") },
            ...
            { "touch.modal.prev", E("НАЗАД", "PREV") },
            { "touch.modal.next", E("ДАЛЬШЕ", "NEXT") },
            ...
            { "touch.drive.rescue_short", E("СПАСТИ", "RESCUE") },
                ...
                { "story.title", E("ПУТЬ НОВИЧКА", "ROOKIE PATH") },
                { "story.hud", E("ПУТЬ НОВИЧКА {0}/{1} • {2}: {3} • {4}/{5}", "ROOKIE PATH {0}/{1} • {2}: {3} • {4}/{5}") },
                { "story.progress", E("{0}: отлично! Прогресс {1}/{2}.", "{0}: great! Progress {1}/{2}.") },
                { "story.character_intro", E("{0}: {1}", "{0}: {1}") },
                { "story.character_progress", E("{0}: {1} ({2}/{3})", "{0}: {1} ({2}/{3})") },
                { "story.character_reward", E("{0}: {1}   +{2:N0} КР   +{3:N0} РЕП", "{0}: {1}   +{2:N0} CR   +{3:N0} REP") },
                ...
                { "story.04.objective", E("Машина долго стояла в мастерской. Дай мотору нагрузку и пройди уличный спринт.", "The car sat in my workshop for a long time. Put the engine under load and finish a street sprint.") },
                { "story.05.title", E("АККУРАТНЫЙ МАРШРУТ", "CLEAN ROUTE") },
                { "story.05.objective", E("Я уже заметил твою машину. Докажи, что умеешь ездить головой: выполни доставку без лишней суеты.", "I have already noticed your car. Prove you can drive with your head: complete a delivery without unnecessary trouble.") },
                { "story.06.title", E("ДВА ПРИКЛЮЧЕНИЯ", "TWO ADVENTURES") },
                { "story.06.objective", E("Город начинает тебя узнавать. Давай заглянем в разные районы — заверши ещё две любые активности.", "The city is starting to recognize you. Let us explore different districts — complete two more activities.") },
                { "story.07.title", E("ПЕРВОЕ КОЛЬЦО", "FIRST CIRCUIT") },
                { "story.07.objective", E("Хватит тренировок по углам. Пора проверить темп на трассе — финишируй в кольцевой гонке.", "Enough angle practice. Time to test your pace on track — finish a circuit race.") },
                { "story.08.title", E("ГОРОДСКОЙ МАСТЕР", "CITY MASTER") },
                { "story.08.objective", E("Ты уже не просто гость. Заработай ещё пару хороших отзывов по городу — заверши две активности.", "You are not just a visitor anymore. Earn a couple more good words around town — complete two activities.") },
                { "story.09.title", E("КОНТРОЛЬНЫЙ ЗАЕЗД", "CHECK RUN") },
                { "story.09.objective", E("На фестивале будет тесно. Если собираешься туда — покажи контроль: пройди этот спринт чисто.", "The festival will be crowded. If you are going there, show control: run this sprint cleanly.") },
                { "story.10.title", E("ФЕСТИВАЛЬ MOTOR CITY", "MOTOR CITY FESTIVAL") },
                { "story.10.objective", E("Вот зачем мы тебя готовили. Весь Motor City смотрит — финишируй в финальной кольцевой гонке.", "This is what we prepared you for. All of Motor City is watching — finish the final circuit race.") },
                { "story.01.progress", E("Ещё немного — детали должны доехать целыми.", "Almost there — the parts need to arrive in one piece.") },
                { "story.01.complete", E("Хорошо довёз. Значит, машину я тебе доверил не зря.", "Good delivery. Looks like I trusted you with the car for a reason.") },
                { "story.02.progress", E("Вот так и узнают город — одно дело за другим.", "That is how you learn the city — one job at a time.") },
                { "story.02.complete", E("Отлично. Теперь у тебя уже есть первое настоящее дело в Motor City.", "Nice. Now you have your first real job in Motor City behind you.") },
                { "story.03.progress", E("Не отпускай угол раньше времени. Держи машину собранной.", "Do not give up the angle too early. Keep the car composed.") },
                { "story.03.complete", E("Уже лучше. В этой машине всё-таки есть характер — и у тебя, похоже, тоже.", "Much better. This car has character after all — and apparently so do you.") },
                { "story.04.progress", E("Слушай мотор и не ломай траекторию. Ему полезно поработать.", "Listen to the engine and keep the line clean. It needs the exercise.") },
                { "story.04.complete", E("Мотор живой. Я бы даже сказал — проснулся.", "The engine is alive. I would even say it finally woke up.") },
                { "story.05.progress", E("Спокойнее. Скорость — не оправдание для бардака на дороге.", "Easy. Speed is not an excuse for making a mess on the road.") },
                { "story.05.complete", E("Вот так лучше. Быстро — ещё не значит без головы.", "That is better. Fast does not have to mean reckless.") },
                { "story.06.progress", E("Один маршрут готов. Выбери ещё одно дело — город большой.", "One route done. Pick another job — the city is big.") },
                { "story.06.complete", E("Теперь ты уже не потеряешься. Даже если очень постараешься.", "Now you probably cannot get lost. Even if you really try.") },
                { "story.07.progress", E("Держи темп. На кольце ошибки возвращаются к тебе на следующем повороте.", "Keep the pace. On a circuit, mistakes come back at the next corner.") },
                { "story.07.complete", E("Неплохо для новичка. Ещё пара таких заездов — и перестану так тебя называть.", "Not bad for a rookie. A couple more runs like that and I may stop calling you one.") },
                { "story.08.progress", E("Ещё одно дело. Покажи, что это уже не случайная удача.", "One more job. Show that this is not just beginner's luck anymore.") },
                { "story.08.complete", E("Город тебя запомнил. Теперь главное — не заставляй его пожалеть.", "The city remembers you now. Just do not make it regret that.") },
                { "story.09.progress", E("Чисто и без глупостей. Перед фестивалем мне проблем не нужно.", "Clean and sensible. I do not need problems before the festival.") },
                { "story.09.complete", E("Ладно. На фестиваль можешь ехать. Но я всё равно буду смотреть.", "All right. You can go to the festival. I will still be watching.") },
                { "story.10.progress", E("Это финал. Не думай о зрителях — смотри на следующую точку.", "This is the finale. Forget the crowd — focus on the next point.") },
                { "story.10.complete", E("Вот теперь ты не новичок. Добро пожаловать в Motor City по-настоящему.", "Now you are not a rookie anymore. Welcome to Motor City for real.") },
        ...
        private static readonly Dictionary<string, LocalizedEntry> TouchPromptOverrides =
            new()
            {
                ...
                { "navigator.controls", E("КНОПКИ ВЫБОРА • ДЕЙСТВИЕ — МАРШРУТ • ОТМЕНА — ЗАКРЫТЬ", "SELECTION BUTTONS • ACTION — ROUTE • CANCEL — CLOSE") },
