    ...
    public static class MotorCityLocalization
    {
        ...
        private static readonly Dictionary<string, LocalizedEntry> Entries =
            new()
            {
                ...
                { "hud.garage_controls", E("1/2/3 УЛУЧШИТЬ • Z/X МАШИНА • V/G/H/J/N/L ВНЕШНИЙ ВИД • E/ESC ЗАКРЫТЬ", "1/2/3 UPGRADE • Z/X CAR • V/G/H/J/N/L STYLE • E/ESC CLOSE") },
                ...
                { "onboarding.activity", E("Едь к синему маркеру ДОСТАВКА, остановись и нажми E", "Drive to the blue DELIVERY marker, stop and press E") },
