    ...
    public static class MotorCityLocalization
    {
        ...
        private static readonly Dictionary<string, LocalizedEntry> Entries =
            new()
            {
                ...
                { "customization.preset_saved", E("ПРЕСЕТ 1 СОХРАНЁН", "PRESET 1 SAVED") },
                { "customization.preset_loaded", E("ПРЕСЕТ 1 ЗАГРУЖЕН", "PRESET 1 LOADED") },
                { "customization.preset_empty", E("ПРЕСЕТ 1 ЕЩЁ ПУСТ", "PRESET 1 IS EMPTY") },
                ...
                { "hud.garage_controls", E("Z/X МАШИНА • V ЦВЕТ • G НАКЛЕЙКА • H ВИНИЛ • J ДИСКИ • N НЕОН • L НОМЕР • F5/F6 ПРЕСЕТ • P ФОТО • E/ESC ЗАКРЫТЬ", "Z/X CAR • V COLOR • G STICKER • H VINYL • J WHEELS • N NEON • L PLATE • F5/F6 PRESET • P PHOTO • E/ESC CLOSE") },
                ...
                { "onboarding.garage_done", E("Гараж найден. Теперь выбери цвет кузова клавишей V.", "Garage found. Now choose a body color with V.") },
                { "onboarding.customize", E("В гараже нажми V и измени цвет машины", "In the garage press V to change the car color") },
