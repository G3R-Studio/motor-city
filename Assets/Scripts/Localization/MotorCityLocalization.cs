    ...
    public static class MotorCityLocalization
    {
        ...
        private static readonly Dictionary<string, LocalizedEntry> Entries =
            new()
            {
                ...
                { "hud.garage_controls", E("Z/X МАШИНА   B КУПИТЬ   V ЦВЕТ   C СКИН ТУРБО   1/2/3 УЛУЧШИТЬ   E/ESC ЗАКРЫТЬ", "Z/X CAR   B BUY   V COLOR   C TURBO SKIN   1/2/3 UPGRADE   E/ESC CLOSE") },
