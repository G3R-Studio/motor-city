    ...
    public static class MotorCityLocalization
    {
        ...
        private static readonly Dictionary<string, LocalizedEntry> Entries =
            new()
            {
                ...
                { "vehicle.next_buy", E("СЛЕДУЮЩАЯ: {0} • {1:N0} КР", "NEXT: {0} • {1:N0} CR") },
                ...
                { "hud.garage_controls", E("1/2/3 УЛУЧШЕНИЯ • Z/X АВТО • V ЦВЕТ • E ЗАКРЫТЬ", "1/2/3 UPGRADES • Z/X CAR • V COLOR • E CLOSE") },
