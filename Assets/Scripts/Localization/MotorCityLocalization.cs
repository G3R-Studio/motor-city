    ...
    public static class MotorCityLocalization
    {
        ...
        private static readonly Dictionary<string, LocalizedEntry> Entries =
            new()
            {
                ...
                { "vehicle.muscle10.desc", E("МАСЛКАР — тяга, вес и мощный разгон", "MUSCLE — torque, weight and strong acceleration") },
                ...
                { "vehicle.doclorean.desc", E("НАБОР ПОДДЕРЖКИ — эксклюзивный ретро-спорткар MOTOR CITY", "SUPPORTER PACK — exclusive MOTOR CITY retro sports car") },
                ...
                { "vehicle.supporter_required", E("{0}: доступен в наборе поддержки MOTOR CITY", "{0}: available in the MOTOR CITY supporter pack") },
                ...
                { "vehicle.next_supporter", E("СЛЕДУЮЩАЯ: {0} • НАБОР ПОДДЕРЖКИ MOTOR CITY", "NEXT: {0} • MOTOR CITY SUPPORTER PACK") },
                ...
                { "customization.color_gray", E("СЕРЫЙ", "GRAY") },
                ...
                { "customization.designersoup.0", E("RALLYE RED", "RALLYE RED") },
                { "customization.designersoup.1", E("PHEONIX YELLOW", "PHEONIX YELLOW") },
                { "customization.designersoup.2", E("BOOST PEARL BLUE", "BOOST PEARL BLUE") },
                { "customization.designersoup.3", E("BLACK PEARL", "BLACK PEARL") },
                ...
                { "customization.muscle.0", E("БОРДОВЫЙ", "BURGUNDY") },
                { "customization.muscle.1", E("ОРАНЖЕВЫЙ", "ORANGE") },
                { "customization.muscle.2", E("ТЁМНО-СИНИЙ", "DEEP BLUE") },
                { "customization.muscle.3", E("ЧЁРНЫЙ", "BLACK") },
                { "customization.muscle.4", E("СЕРЕБРО", "SILVER") },
                { "customization.muscle.5", E("СЛОНОВАЯ КОСТЬ", "IVORY") },

                { "customization.hybrid.0", E("ЧЁРНЫЙ", "BLACK") },
                { "customization.hybrid.1", E("СИНИЙ", "BLUE") },
                { "customization.hybrid.2", E("ЗОЛОТО", "GOLD") },
                { "customization.hybrid.3", E("ЗЕЛЁНЫЙ", "GREEN") },
                { "customization.hybrid.4", E("ГОЛУБОЙ", "LIGHT BLUE") },
                { "customization.hybrid.5", E("ФИОЛЕТОВЫЙ", "PURPLE") },
                { "customization.hybrid.6", E("КРАСНЫЙ", "RED") },
                { "customization.hybrid.7", E("СЕРЕБРО", "SILVER") },
                { "customization.hybrid.8", E("БЕЛЫЙ", "WHITE") },
                { "customization.hybrid.9", E("ЖЁЛТЫЙ", "YELLOW") },

                { "customization.tristar.0", E("ГОНОЧНЫЙ КРАСНЫЙ", "RACING RED") },
                { "customization.tristar.1", E("СОЛНЕЧНЫЙ ЖЁЛТЫЙ", "SOLAR YELLOW") },
                { "customization.tristar.2", E("ЭЛЕКТРИЧЕСКИЙ СИНИЙ", "ELECTRIC BLUE") },
                { "customization.tristar.3", E("ПОЛНОЧНЫЙ ЧЁРНЫЙ", "MIDNIGHT BLACK") },
                { "customization.tristar.4", E("ТИТАН", "TITANIUM") },
                { "customization.tristar.5", E("ЖЕМЧУЖНЫЙ БЕЛЫЙ", "PEARL WHITE") },

                { "customization.van.0", E("БЕЛЫЙ", "WHITE") },
                { "customization.van.1", E("СЛУЖЕБНЫЙ СИНИЙ", "DELIVERY BLUE") },
                { "customization.van.2", E("КРАСНЫЙ", "RED") },
                { "customization.van.3", E("ТАКСИ ЖЁЛТЫЙ", "TAXI YELLOW") },
                { "customization.van.4", E("ГРАФИТ", "GRAPHITE") },
                { "customization.van.5", E("МЯТНЫЙ", "MINT") },

                { "customization.doclorean.0", E("НЕРЖАВЕЮЩАЯ СТАЛЬ", "STAINLESS STEEL") },
                { "customization.doclorean.1", E("ПОЛНОЧНЫЙ ЧЁРНЫЙ", "MIDNIGHT BLACK") },
                { "customization.doclorean.2", E("НЕОНОВЫЙ СИНИЙ", "NEON BLUE") },
                { "customization.doclorean.3", E("РЕТРО-КРАСНЫЙ", "RETRO RED") },
                { "customization.doclorean.4", E("ЖЕМЧУЖНЫЙ БЕЛЫЙ", "PEARL WHITE") },
                ...
                { "customization.wheel.0", E("СЕРЕБРО", "SILVER") },
                { "customization.wheel.1", E("СТАНДАРТ", "STANDARD") },
                ...
                { "navigator.controls", E("КНОПКИ НИЖЕ — ВЫБОР • ENTER — ПРОЛОЖИТЬ МАРШРУТ • ESC / M — ЗАКРЫТЬ", "BUTTONS BELOW — SELECT • ENTER — SET ROUTE • ESC / M — CLOSE") },
                ...
                { "activity.best_short", E(" • РЕКОРД: {0:0.0}с", " • BEST: {0:0.0}s") },
                { "activity.elite_hint", E(" • ЭЛИТА: SHIFT+E", " • ELITE: SHIFT+E") },
                { "activity.premium_hint", E(" • ПРЕМИУМ: SHIFT+E", " • PREMIUM: SHIFT+E") },
                { "activity.elite_locked", E(" • ЭЛИТА: нужен ур. {1} «{0}»", " • ELITE: requires {0} lvl {1}") },
                { "activity.premium_locked", E(" • ПРЕМИУМ: нужен ур. {1} «{0}»", " • PREMIUM: requires {0} lvl {1}") },
                { "activity.start_time", E("{0} • E — НАЧАТЬ • ЗОЛОТО ≤ {1:0}с • СЕРЕБРО ≤ {2:0}с • БРОНЗА ≤ {3:0}с{4}{5}", "{0} • E — START • GOLD ≤ {1:0}s • SILVER ≤ {2:0}s • BRONZE ≤ {3:0}s{4}{5}") },
                ...
                { "challenge.best_speed", E(" • РЕКОРД: {0:0} {1}", " • BEST: {0:0} {1}") },
                { "challenge.best_distance", E("   РЕК {0:0.0} М", "   BEST {0:0.0} M") },
                { "challenge.reward", E(" • НАГРАДА: +{0:N0} КР, +{1:N0} РЕП", " • REWARD: +{0:N0} CR, +{1:N0} REP") },

                { "driftspot.live", E("ДРИФТ-ТОЧКА: {0} • ОЧКИ: {1:N0} • БРОНЗА: {2:N0} • СЕРЕБРО: {3:N0} • ЗОЛОТО: {4:N0}", "DRIFT SPOT: {0} • SCORE: {1:N0} • BRONZE: {2:N0} • SILVER: {3:N0} • GOLD: {4:N0}") },
                { "driftspot.prompt", E("ДРИФТ-ТОЧКА: {0} • БРОНЗА: {1:N0} • СЕРЕБРО: {2:N0} • ЗОЛОТО: {3:N0}", "DRIFT SPOT: {0} • BRONZE: {1:N0} • SILVER: {2:N0} • GOLD: {3:N0}") },
                { "driftspot.result", E("ДРИФТ-ТОЧКА: {0} • ОЧКИ: {1:N0} • МЕДАЛЬ: {2}{3}{4}", "DRIFT SPOT: {0} • SCORE: {1:N0} • MEDAL: {2}{3}{4}") },

                { "speedtrap.status", E("РАДАР: {0} • СКОРОСТЬ: {1:0} {2} • МЕДАЛЬ: {3}{4}{5}", "SPEED TRAP: {0} • SPEED: {1:0} {2} • MEDAL: {3}{4}{5}") },
                ...
                { "pause.controls", E("ИСПОЛЬЗУЙ КНОПКИ НИЖЕ   •   ESC — ПРОДОЛЖИТЬ", "USE THE BUTTONS BELOW   •   ESC — RESUME") },
            ...
            { "touch.garage.skin", E("ПИКСИ", "PIXIE") },
            { "touch.garage.preset1", E("ПРЕСЕТ 1", "PRESET 1") },
            { "touch.garage.preset2", E("ПРЕСЕТ 2", "PRESET 2") },
            { "touch.garage.preset3", E("ПРЕСЕТ 3", "PRESET 3") },
            { "touch.garage.save", E("СОХРАНИТЬ", "SAVE") },
            { "touch.garage.load", E("ЗАГРУЗИТЬ", "LOAD") },
            ...
            { "touch.drive.rescue_short", E("СПАСТИ", "RESCUE") },
                ...
                { "club.controls_join", E("КНОПКИ НИЖЕ — ВЫБОР   •   E / ENTER — ВСТУПИТЬ   •   ESC / U — ЗАКРЫТЬ", "BUTTONS BELOW — SELECT   •   E / ENTER — JOIN   •   ESC / U — CLOSE") },
                { "club.controls_member", E("КНОПКИ НИЖЕ — ДРУГИЕ КЛУБЫ   •   E / ENTER — СМЕНИТЬ КЛУБ   •   ESC / U — ЗАКРЫТЬ", "BUTTONS BELOW — OTHER CLUBS   •   E / ENTER — SWITCH CLUB   •   ESC / U — CLOSE") },
                ...
                { "store.title", E("МАГАЗИН MOTOR CITY", "MOTOR CITY STORE") },
                { "store.supporter.name", E("НАБОР ПОДДЕРЖКИ MOTOR CITY", "MOTOR CITY SUPPORTER PACK") },
                { "store.supporter.desc", E("Постоянный набор поддержки MOTOR CITY: 5 000 кредитов и эксклюзивный docLorean.", "Permanent MOTOR CITY supporter pack: 5,000 credits and the exclusive docLorean.") },
                { "store.supporter.details", E("5 000 КРЕДИТОВ • docLorean • ПОКУПКА НАВСЕГДА", "5,000 CREDITS • docLorean • PERMANENT PURCHASE") },
        ...
        private static readonly Dictionary<string, LocalizedEntry> TouchPromptOverrides =
            new()
            {
                ...
                { "activity.elite_hint", E(" • ЭЛИТА: РУЧНИК + ДЕЙСТВИЕ", " • ELITE: HANDBRAKE + ACTION") },
                { "activity.premium_hint", E("   УДЕРЖИВАЙ РУЧНИК + ДЕЙСТВИЕ — ПРЕМИУМ", "   HOLD HANDBRAKE + ACTION — PREMIUM") },
                { "activity.start_time", E("{0} • ДЕЙСТВИЕ — НАЧАТЬ • ЗОЛОТО ≤ {1:0}с • СЕРЕБРО ≤ {2:0}с • БРОНЗА ≤ {3:0}с{4}{5}", "{0} • ACTION — START • GOLD ≤ {1:0}s • SILVER ≤ {2:0}s • BRONZE ≤ {3:0}s{4}{5}") },
