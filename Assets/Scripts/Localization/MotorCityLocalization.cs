    ...
    public static class MotorCityLocalization
    {
        ...
        private static readonly Dictionary<string, LocalizedEntry> Entries =
            new()
            {
                ...
                { "turbo.reunion", E("Пикси: Я скучал! Ничего не потеряно — просто поехали кататься.", "Pixie: I missed you! Nothing was lost — let’s go for a drive.") },
                { "turbo.mood_happy", E("РАДОСТНЫЙ", "HAPPY") },
                { "turbo.level_up", E("Пикси получил уровень {0}! Новые способности становятся сильнее.", "Pixie reached level {0}! His abilities are getting stronger.") },
                { "turbo.daily_any", E("ПИКСИ • Выполни любые активности: {0}/{1}", "PIXIE • Complete any activities: {0}/{1}") },
                { "turbo.daily_race", E("ПИКСИ • Заверши гонку: {0}/{1}", "PIXIE • Finish a race: {0}/{1}") },
                { "turbo.daily_drift", E("ПИКСИ • Заверши дрифт-заезд: {0}/{1}", "PIXIE • Finish a drift challenge: {0}/{1}") },
                { "turbo.daily_done", E("ПИКСИ • Задание на сегодня выполнено", "PIXIE • Today’s task is complete") },
                { "turbo.daily_progress", E("Пикси: Отлично! Задание {0}/{1}.", "Pixie: Nice! Task progress {0}/{1}.") },
                { "turbo.daily_reward", E("Пикси: Задание готово! +{0:N0} КР и опыт Пикси.", "Pixie: Task complete! +{0:N0} CR and Pixie XP.") },
                { "turbo.new_daily", E("Пикси: Новое приключение на сегодня готово!", "Pixie: Today’s new adventure is ready!") },
                { "turbo.hint", E("Пикси: Не спеши — цель уже отмечена на миникарте.", "Pixie: No rush — your target is already marked on the minimap.") },
                { "turbo.boost", E("Пикси: Пуск! Короткий буст активирован.", "Pixie: Go! Short boost activated.") },
                { "turbo.garage_skin", E("ПИКСИ • СКИН: {0}", "PIXIE • SKIN: {0}") },
                ...
                { "turbo.skin_cosmetic_pack", E("ПИКСИ-ИСКРА", "PIXIE SPARK") },
                { "turbo.skin_unlocked", E("Пикси: открыт новый скин «{0}»!", "Pixie: new skin “{0}” unlocked!") },
                { "turbo.skin_selected", E("Пикси: выбран скин «{0}».", "Pixie: “{0}” skin selected.") },
