...
- baked decorative parked vehicles from the Fantastic City Generator city are removed when the runtime city loads, keeping parking areas and activity access points clear for the player car;
