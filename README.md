...
- Prometeo acceleration, steering, service braking, coasting and handbrake traction-loss behavior, with Motor City garage upgrades mapped onto the controller tuning; the player can switch a persistent three-mode driving profile at runtime: Comfort for stable everyday driving, Sport for maximum acceleration/speed and high rear-axle traction, and Drift for sharper steering, reduced rear lateral grip and stronger handbrake traction break;
