...
- FCG pedestrian traffic-light visuals are sanitized when the runtime city is baked/loaded: overlapping walk/hand renderers are reduced to one stable state and conflicting pedestrian materials are normalized to prevent both signals from flickering together;
